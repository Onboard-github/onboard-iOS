...
protocol PlayerUseCase {
    ...
    func fetchAddPlayer(groupId: Int, nickName: String) async throws -> AddPlayerEntity.Res
...
final class PlayerUseCasempl: PlayerUseCase {
    ...
    func fetchAddPlayer(groupId: Int, nickName: String) async throws -> AddPlayerEntity.Res {
        try await self.repository.requestAddPlayer(groupId: groupId, nickName: nickName)
    }
