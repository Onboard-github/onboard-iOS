...
enum OBRouter: URLRequestConvertible {
    ...
    var method: HTTPMethod {
        switch self {
        case .testAPI, .groupList, .gameList, .randomImage, .getTerms, .gameResult, .gamePlayer, .groupMembers, .groupInfo, .getMe, .getMyGroupsV2, .validateNickname, .forceUpdateTest, .gameLeaderboard, .getMatchCount:
            return .get
    ...
    var path: String {
        ...
        case let .getMatchCount(groupId, memberId):
            return "api/v1/group/\(groupId)/member/\(memberId)/match/count"
        }
    }
    ...
    var header: Header? {
        ...
        case .testAPI, .auth, .addGroup, .groupList, .randomImage, .validateNickname:
            return nil
        case .setUser, .gameList, .getTerms, .createGroup, .groupMemeberPatch, .groupMembers, .addGroupGuest, .groupInfo, .getMe, .getMyGroupsV2, .gameResult, .gamePlayer, .myGroupUnsubscribe, .groupDelete, .groupAccessCodeCheck, .joinGroupHost, .forceUpdateTest, .gameLeaderboard, .match, .agreeTerms, .deleteUserMe, .assignOwner, .getMatchCount:
    ...
    var body: Body? {
        ...
        case .testAPI, .groupList, .gameList, .pickerImage, .randomImage, .getTerms, .groupMemeberPatch, .groupMembers, .groupInfo, .getMe, .getMyGroupsV2, .gameResult, .gamePlayer, .myGroupUnsubscribe, .groupDelete, .validateNickname, .forceUpdateTest, .gameLeaderboard, .deleteUserMe, .assignOwner, .getMatchCount:
            return nil
    ...
    var params: Params? {
        switch self {
        case .testAPI, .auth, .addGroup, .setUser, .gameList, .randomImage, .createGroup, .getTerms, .groupMemeberPatch, .addGroupGuest, .groupInfo, .getMe, .getMyGroupsV2, .myGroupUnsubscribe, .groupDelete, .groupAccessCodeCheck, .joinGroupHost, .forceUpdateTest, .gameLeaderboard, .match, .agreeTerms, .gameResult, .deleteUserMe, .assignOwner, .getMatchCount:
            return nil
